...
1. Create, compile, and deploy just the contract file in a testing environment like Remix. 
    - you can find audited boilerplate contracts at sites like OpenZeppelin.
...
* A WalletContext.jsx for more fluid interactions while navigating within the domain
