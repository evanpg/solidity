...
3. Once there at least 3 participants the admin  can call the *pickWinner* function. A a random number determines the winner, and the balance accumulated goes to winning participant's address.
